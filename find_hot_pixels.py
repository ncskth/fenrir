...
#fig = plt.figure()
#ax = fig.add_subplot()
#ax.imshow(accumulator_left)
#plt.show()
#ax.imshow(accumulator_right)
#plt.show()

hot_pixels_left_x, hot_pixels_left_y = np.where(accumulator_left > 1)
np.save("hot_pixels_left_x.npy", hot_pixels_left_x)
np.save("hot_pixels_left_y.npy", hot_pixels_left_y)
#print(hot_pixels_left_x)
#print(hot_pixels_left_y)
#fig = plt.figure()
#ax = fig.add_subplot()
#ax.scatter(hot_pixels_left_x, hot_pixels_left_y)
#plt.show()
hot_pixels_right_x, hot_pixels_right_y = np.where(accumulator_right > 1)
#print(hot_pixels_right_x)
#print(hot_pixels_right_y)
#fig = plt.figure()
#ax = fig.add_subplot()
#ax.scatter(hot_pixels_right_x, hot_pixels_right_y)
#plt.show()
np.save("hot_pixels_right_x.npy", hot_pixels_right_x)
np.save("hot_pixels_right_y.npy", hot_pixels_right_y)